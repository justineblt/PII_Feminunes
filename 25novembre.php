...
<table>
<tr>
    <td class="flecheg"> <a href="rojava.php"> <img class="fleche" src="img/flechegch.png" alt="flèche"></a></td>
    <td class="couv"><img class="entetearticle" src="img/125nov.png" alt="rojava"></td>
    <td class="fleched"><a href="rojava.php"><img class="fleche" src="img/flechedrt.png" alt="flèche"></a></td>
</table>

    <p class="titrearticle">25 novembre</p><hr/>
