...
<div class="finpartiecolonne">
    ...
    <img src="Images/happytacos.png" height="30%" width="30%">
 
    <div id="colf1">
    <h2> Félicitations ! </h2> <p> Tu as eu plus de 80 % de bonnes réponses. <br/>
    <p> Bien jouée, as-tu battu ton meilleure score qui était de <?php echo $donnees2['max']; ?> / 100 toutes parties confondues??? </p>
    </div>
</div>
<img class="gif" src="Images/tete.gif">
<hr/>

<form action="LesQuizs.php" method="post">
