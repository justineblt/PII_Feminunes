...
<div id="conteneur">
         <div class="colonne1"> <a href="Inscription.php"> <button type="button" class="boutonautre"> S'inscrire </button> </a> </div> 
         <div class="colonne2"> <a href="Identification.php"> <button type="button" class="boutonautre"> S'identifier </button> </a> </div>
