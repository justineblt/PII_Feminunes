  ...
  <section class="body">
    ...
    <div class="caseblanche">
      ...
      <p class="corpstextecenter">
        découvre nos catégories...<br />
      </p>

      <table>
        <tr>
          <td class="colonne1"><a href=temoignage.php><img class="btnarticle" src="img/temoignage.png" alt="témoignage"></a></td>
          <td class="colonne2"><a href=histoire.php><img class="btnarticle" src="img/histoire.png" alt="histoire"></a></td>
        </tr>
        <tr>
          <td class="colonne1"><a href=sujets.php><img class="btnarticle" src="img/sujets.png" alt="sujet d'éducation"></a></td>
          <td class="colonne2"><a href=portrait.php><img class="btnarticle" src="img/portrait.png" alt="portrait"></a></td>
        </tr>
      </table>
